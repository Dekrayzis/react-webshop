...
const Privacy = () => {
  return (
    <div class="container page_container">
      <h1 class="page_title">Terms and Service</h1>
      ...
      <div class="rte">
        ...
        <p>
          <span>Last updated: May 31, 2016</span>
        </p>
        <p>
          <span>
        ...
        <p>
          <span>
            ...
            with these Terms and Conditions, the Promotion rules will apply.
          </span>
        </p>
        <br />
        <p>
        ...
        <p>
          <span>
            ...
            make your Content available to other users of the Service, who may
        ...
        <p>
          <span>
            ...
            or any person using your account and password; b) a breach of these
        ...
        <p>
          <span>
            ...
            laws of Nevada, United States, without regard to its conflict of law
            provisions.
          </span>
        </p>
        <p>
        ...
        <p>
          <span>
            This Privacy Policy is effective as of May 31, 2016 and will remain
